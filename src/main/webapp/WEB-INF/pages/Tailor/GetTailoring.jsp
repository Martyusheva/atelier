...
<div>
            <span class="design-block">
                <div class="center">
                    <h2>Get Tailoring Request</h2>
                </div>
                                                <form method="post">
  <label for="action">Get request:</label>
  <select style="color:black" name="tailoring_id" id="action">

              <%
                  ArrayList<Tailoring> tailoringList = (ArrayList<Tailoring>) session.getAttribute("tailoringList");
  ...
  <button formaction="/GetTailoring" style="color:black" type="submit" name="submit" value="submit">Ok</button>
</form>
